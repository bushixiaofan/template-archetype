package com.song.samples.archetype.aop.aspect;
...
public class HelloAspect {
    ...
    @Pointcut(value = "execution(* com.song.samples.archetype.service.*.*(..)) || @annotation(com.song.samples.archetype.aop.annot.HelloAnnotation)")
